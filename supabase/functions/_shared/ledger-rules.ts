...
export const PL_DEBIT_RULES: LedgerRule[] = [
  ...
  { pattern: /\b(salar|wages|staff\s+salary|payroll|employer\s+pf|pf\s+contribution)\b/i, target: { statement: 'pl', key: 'employee_benefits_expense', noteHead: 'Salaries & wages' } },
  ...
  { pattern: /\baudit\s+fees?(?!\s+payable)\b/i, target: { statement: 'pl', key: 'other_expenses', noteHead: 'Audit fee' } },
  ...
  { pattern: /\bpromotion|advertis/i, target: { statement: 'pl', key: 'other_expenses', noteHead: 'Sales promotion' } },
  { pattern: /\binsurance\b/i, target: { statement: 'pl', key: 'other_expenses', noteHead: 'Insurance' } },
  { pattern: /\blegal\b/i, target: { statement: 'pl', key: 'other_expenses', noteHead: 'Legal & professional' } },
